...
class AskoApi {
   ...
   *   Request object.
   */
  public function getAskoApplicationRequest(Application $application, string $projectName): AskoApplicationRequest {
    return new AskoApplicationRequest($application, $projectName);
  }
