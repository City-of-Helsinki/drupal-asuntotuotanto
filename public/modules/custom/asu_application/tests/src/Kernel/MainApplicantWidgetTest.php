...
final class MainApplicantWidgetTest extends KernelTestBase {
  ...
  /**
   * Build widget form element for the application main_applicant field.
   *
  ...
  private function buildWidgetElement(Application $application): array {
    $items = $application->get('main_applicant');
    $field_definition = $items->getFieldDefinition();
    $widget = MainApplicantWidget::create(
      $this->container,
      [
      ...
      [
        ...
        'field_types' => ['asu_main_applicant'],
      ]
    );
