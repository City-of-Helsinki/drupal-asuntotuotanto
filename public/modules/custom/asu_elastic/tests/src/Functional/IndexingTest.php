...
final class IndexingTest extends ExistingSiteBase {
  ...
  public function testElasticSearchIndexing() {
    ...
    // Indexed as computed field, autogenerated machine readable name.
    #$this->assertIsArray($data['project_holding_type']);
    #$this->assertEquest($data['project_holding_type'][0], 'RIGHT_OF_RESIDENCE_APARTMENT');
